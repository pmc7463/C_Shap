...
namespace Operator
{
    public partial class Form1 : Form
    {
        ...
        {
            tboxResultBit.Text = Convert.ToString(int.Parse(tboxResult.Text), 2);   // 진수 변환
        }
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            tboxResult.Text = (++iTemp).ToString(); //값을 넣기 전에 더하기
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            tboxResult.Text = (iTemp++).ToString(); // 값을 넣고나서 더하기
            tboxResultAfter.Text = iTemp.ToString();
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            bool bResult = (iTemp1 > iTemp2 && iTemp1 < iTemp2);
